...
from networks.yolo import yolo_eval, yolo_body
#from networks.yolo_copy import yolo_body
...
class YOLO:
    ...
    def detect_image(self, image):
        ...
        x.append(preds[0].numpy())
        x.append(preds[1].numpy())
        x.append(preds[2].numpy())
        #boxes , scores, classes = postprocess_yolo(x, self.anchors, image.size[0], image.size[1])
        #print(boxes)
    ...
    def test_tensorrt(self, img):
        
        img_resized = preprocess_yolo(img)
